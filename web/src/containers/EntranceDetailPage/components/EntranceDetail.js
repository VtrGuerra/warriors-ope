  ...
  return (
    <main className={classes.content}>
      ...
      >
        <Grid item>
          <Chip
            label={`ID da entrada: ${entranceId}`}
            color="primary"
            className={classes.chips}
          />
          <Chip
            label={`Data da Entrada: ${new Date(date).toLocaleDateString(
              'pt-BR',
            )}`}
            color="primary"
            className={classes.chips}
          ...
          <Chip
            label={
              selectSupplier(supplier).isCompany
                ? 'CNPJ: ' + selectSupplier(supplier).CNPJ
                : 'CPF: ' + selectSupplier(supplier).CPF
            }
            color="primary"
            className={classes.chips}
          />
          <br />
          <Chip
            label={`Forma de Pagamento: ${formOfPayment}`}
            color="primary"
            className={classes.chips}
          />
          <br />
          <Chip
            label={`Preço Total: R$${totalPrice}`}
            color="primary"
            className={classes.chips}
          />
        </Grid>
