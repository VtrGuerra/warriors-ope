...
import { generateEntranceId } from '../meta/generateEntranceId'
...
function AddEntrance({
  ...
  const onSubmit = (formValues) => {
    dispatchAddEntrance(formValues)
  }
  ...
  useEffect(() => {
    initialize({ entranceId: generateEntranceId() })
    dispatchGetProducts()
...
export default memo(AddEntrance)
